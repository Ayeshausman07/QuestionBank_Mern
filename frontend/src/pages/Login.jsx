            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <p>{errorMessage}</p>
                  <p className="mt-1">
                    Contact support at <span className="font-semibold">support@questionbank.com</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        setError(
          <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-lg">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-red-700">{errorMessage || "Invalid email or password"}</p>
              </div>
            </div>
          </div>
        );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mt-4">Question Bank</h1>
